...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/01/22 18:45:10 by vchizhov          #+#    #+#              #
#    Updated: 2023/01/31 18:06:55 by vchizhov         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BONUS = ft_lstnew.c ft_lstsize.c ft_lstlast.c ft_lstadd_back.c ft_lstdelone.c \
		ft_lstclear.c ft_lstiter.c ft_lstmap.c ft_lstadd_front.c
